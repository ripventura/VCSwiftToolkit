...
extension Dictionary {
    ...
    mutating func vcAppendDictionary(otherDict : Dictionary) {
...
extension UIImage {
     ...
     */
    func vcImageBasedOnImage() -> UIImage {
     ...
     */
    func vcScaleToNewSize(newSize : CGSize) -> UIImage {
     ...
     */
    func vcRotateFlipByAngle(degrees : CGFloat, flip : Bool = false) -> UIImage {
     ...
     */
    func vcRoundCorners(cornerRadius : CGFloat) -> UIImage {
...
extension String {
     ...
     */
    func vcStringFromBase64String() -> String? {
     ...
     */
    func vcImageFromBase64String() -> UIImage? {
     ...
     */
    func vcDrawImage(font : UIFont, color : UIColor, contextSize : CGSize) -> UIImage {
