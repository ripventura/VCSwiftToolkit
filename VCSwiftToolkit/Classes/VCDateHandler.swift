...
public let sharedDateHandler : VCDateHandler = VCDateHandler()
...
open class VCDateHandler {
     ...
     */
    open func stringFromDate(date : Date, dateFormat : DateFormat, timezoneName : String) -> String {
     ...
     */
    open func stringFromDateForCurrentTimezone(date : Date, dateFormat : DateFormat) -> String {
     ...
     */
    open func stringFromDateForUTCTimezone(date : Date, dateFormat : DateFormat) -> String {
     ...
     */
    open func dateFromString(string : String, dateFormat : DateFormat, timezoneName : String) -> Date? {
     ...
     */
    open func dateFromStringForCurrentTimezone(string : String, dateFormat : DateFormat) -> Date? {
     ...
     */
    open func dateFromStringForUTCTimezone(string : String, dateFormat : DateFormat) -> Date? {
     ...
     */
    open func readableIntervalBetweenDates (interval : TimeInterval) -> String {
     ...
     */
    open func setYearForDate(date : Date, year : Int, referenceTimezone : TimeZone = sharedLocaleHelper.currentTimezone()) -> Date {
     ...
     */
    open func setMonthForDate(date : Date, month : Int, referenceTimezone : TimeZone = sharedLocaleHelper.currentTimezone()) -> Date {
     ...
     */
    open func setDayForDate(date : Date, day : Int, referenceTimezone : TimeZone = sharedLocaleHelper.currentTimezone()) -> Date {
     ...
     */
    open func setTimeForDate(date : Date, hour : Int, minute : Int, second : Int, referenceTimezone : TimeZone = sharedLocaleHelper.currentTimezone()) -> Date {
     ...
     */
    open func operateTimeToDate(date : Date, hour : Int, minute : Int, second : Int) -> Date {
     ...
     */
    open func operateDaysToDate(date : Date, days : Int) -> Date {
     ...
     */
    open func operateWeeksToDate(date : Date, weeks : Int) -> Date {
     ...
     */
    open func operateMonthsToDate(date : Date, months : Int) -> Date {
     ...
     */
    open func operateYearsToDate(date : Date, years : Int) -> Date {
     ...
     */
    open func isDateInBetween(date : Date, startDate : Date, endDate : Date, includeEquals : Bool = true) -> Bool {
